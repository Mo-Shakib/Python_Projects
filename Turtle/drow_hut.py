...
t.goto(-150, -120) 
t.pendown() 
drawRectangle(t, 100, 110, "firebrick") 

# Draw and fill the front door 
t.penup() 
t.goto(-120, -120) 
t.pendown() 
drawRectangle(t, 40, 60, "dark gray") 

# Front roof 
t.penup() 
t.goto(-150, -10) 
t.pendown() 
drawTriangle(t, 100, "goldenrod") 

# Side of the house 
t.penup() 
t.goto(-50, -120) 
t.pendown() 
drawParallelogram(t, 60, 110, "firebrick") 

# Window 
t.penup() 
t.goto(-30, -60) 
t.pendown() 
drawParallelogram(t, 20, 30, "dark goldenrod") 
